          ...
          <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
            <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
              ...
              <div className='grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6'>
                <StatsCard title='Total Tasks' value={stats.totalCount} icon={<Circle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-500'/>}/>
                <StatsCard title='Completed' value={stats.completedTasks} icon={<Circle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-500'/>}/>
                <StatsCard title='Pending' value={stats.pendingCount} icon={<Circle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-fuchsia-500'/>}/>
                <StatsCard title='Completion Rate' value={`${stats.completionPercentage} %`} icon={<Zap className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-500'/>}/>
              </div>
